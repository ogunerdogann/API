...
public class C23_Get_Deserialization extends DummyBaseUrl{
    ...
    public void get01(){
        ...
        HashMap<String,Object> expData = testDataDummy.expectedDataOlusturMAP();
        ...
        //4- Assertion
        HashMap<String,Object> respMap = response.as(HashMap.class); //dönen response'u Map'e ceviriyoruz
